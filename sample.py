...
def parse_args():
    ...
    parser.add_argument("--model", type=str, default='MDFF')
    parser.add_argument("--ckpt_path", type=str, default='./model/x4.pth.tar')
    parser.add_argument("--group", type=int, default=4)
    parser.add_argument("--sample_dir", type=str, default='sample')
    parser.add_argument("--test_data_dir", type=str, default="./datasets/Set5")
...
def sample(net, dataset, cfg):
    ...
    for step, (hr, lr, name) in enumerate(dataset):
        ...
        sr_dir = os.path.join(cfg.sample_dir, model_name,"SR",
                              cfg.test_data_dir.split("/")[-1],
                              "x{}".format(cfg.scale)
                              )

        hr_dir = os.path.join(cfg.sample_dir,model_name, "HR",cfg.test_data_dir.split("/")[-1],
                              "x{}".format(cfg.scale)
                              )
